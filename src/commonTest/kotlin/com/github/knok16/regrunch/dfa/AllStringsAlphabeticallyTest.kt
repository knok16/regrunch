...
import com.github.knok16.regrunch.dfa.Fixtures.infiniteNumberOfStringsAlphabeticallySmallerThatAny
...
class AllStringsAlphabeticallyTest {
    ...
    fun wordEndsInIng() {
        assertEquals(
            listOf("ING", "INg", "InG", "Ing", "iNG", "iNg", "inG", "ing"),
            wordEndsInIng.allStringsAlphabetically(3).toList()
        )
    }

    @Test
    fun noConsecutiveOnesOfLengthUpTo4() {
        assertEquals(
            listOf(
                "",
                "0",
            ...
            noConsecutiveOnes.allStringsAlphabetically(4).toList()
        )
    }
    ...
    fun finalStateIsNotReachableFromStart() {
        assertEquals(
            emptyList(),
            finalStateIsNotReachableFromStart.allStringsAlphabetically().toList()
        )
    }
    ...
    fun infiniteNumberOfStringsAlphabeticallySmallerThatAny() {
        assertEquals(
            ...
            infiniteNumberOfStringsAlphabeticallySmallerThatAny.allStringsAlphabetically(10).toList()
        )
    }
    ...
    fun anyStrings() {
        assertEquals(
            1 + 96 + 96 * 96 + 96 * 96 * 96,
            anyStringDFA((0x20.toChar()..0x7F.toChar()).toSet()).allStringsAlphabetically(3).count()
        )
    }
    ...
    fun evenOnes() {
        assertEquals(
            ...
            evenOnes.allStringsAlphabetically(5).toList()
        )
    }
    ...
    fun oddZeroes() {
        assertEquals(
            ...
            oddZeroes.allStringsAlphabetically(5).toList()
        )
    }
    ...
    fun divisibilityBy() {
        assertEquals(
            ...
            Fixtures.divisibilityBy(7).allStringsAlphabetically(3).toList()
        )
    }

    @Test
    fun noConsecutiveOnesOfLengthUpTo5() {
        assertEquals(
            listOf(
                "",
                "0",
            ...
            noConsecutiveOnes.allStringsAlphabetically(5).toList()
        )
    }

    @Test
    fun no3Consecutive0OfLengthUpTo3() {
        assertEquals(
            anyStringDFA(no3Consecutive0.alphabet).allStringsAlphabetically(3).filter { it != "000" }.toList(),
            no3Consecutive0.allStringsAlphabetically(3).toList()
        )
    }

    @Test
    fun no3Consecutive0OfLengthUpTo5() {
        assertEquals(
            listOf(
                "",
                "0",
            ...
            no3Consecutive0.allStringsAlphabetically(5).toList()
        )
    }
    ...
    fun no3Consecutive012() {
        assertEquals(
            ...
            no3Consecutive012.allStringsAlphabetically(5).toList()
        )
    }
}
